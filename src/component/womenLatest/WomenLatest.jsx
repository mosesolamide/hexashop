...
import { LatestWomen } from "./LatestWoman"
import { Link } from "react-router-dom"
import { MdOutlineShoppingCart } from "react-icons/md"
import { IoMdHeart } from "react-icons/io"
import { FaRegHeart } from "react-icons/fa"

export default function WomenLatest(){
    const womenLatest = LatestWomen.map( (dress,index) => {
        const [liked,setLiked] = useState(dress.isLike)
        return(
            <div className="bg-[#D9D9D9]" key={index}>
                ...
                <div className="flex mx-1 my-2 items-center">
                    ...
                    <div className="flex gap-[2px]">
                        ...
                        <Link
                            ...
                            state={dress}
                         >
                            <MdOutlineShoppingCart className=" w-[6px] sm:w-[9px] md:w-[12px]"/>
                        </Link>
                    </div>
                </div>
            </div>
